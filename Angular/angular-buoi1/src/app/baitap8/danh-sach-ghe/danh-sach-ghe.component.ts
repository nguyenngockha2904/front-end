...
export class DanhSachGheComponent implements OnInit {
  ...
  constructor() { }
  @ViewChildren(GeComponent)
  gheComponents:QueryList<GeComponent>;
  ...
  handleCancel(soGhe:number):void{
    // let index = this.mangGhe.findIndex(item=>item.soGhe ===soGhe);
    // console.log(soGhe);
    this.gheComponents.forEach((item:GeComponent)=>{
